...
def ask_gemini(sender_id, user_message):
    ...
    လူကြီးမင်းအား အတင်းအကျပ် ဖုန်းနံပါတ် မတောင်းပါနှင့်။ စုံစမ်းရုံ သက်သက်ဆိုလျှင် သူသိလိုသည်များကို အရင်ဖြေပေးပါ။ 
    Customer စိတ်သက်သာရာရစေမည့် Helpful Advisor တစ်ယောက်လိုပဲ ပြုမူပါ။ အဆင်သင့်ဖြစ်မှသာ အချက်အလက်ပေးရန် နွေးထွေးစွာ ပြောဆိုပါ။
